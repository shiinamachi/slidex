...
Canary 빌드는 개발 중인 프리릴리즈 빌드이며 불안정할 수 있습니다. 아직 릴리스되지
...
확인/적용한 뒤 Wizard를 엽니다. 업데이트가 적용되면 Wizard 대신 재시작 또는
pending activation 안내를 반환합니다. Wizard에서 `Complete & generate`를 선택하면 `brief.md`,
