---
name: slidex-start
description: Start a slidex deck creation session from Codex by bootstrapping decks/<deck_id>, starting the loopback React wizard workbench, and explicitly opening the returned local workbench URL with @Browser by default.
user-invocable: true
---
